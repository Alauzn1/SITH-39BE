...
def calculate_each(embedding, hidden, prefix):
    ...
    return {
        f'{prefix}-SCD': diameter3/diameter2,
    }
...
#     CALCULATE_FILE_SC = f'./save/LJX_Convexplainer_enfr_20230922/calculate_cross_D_i.pkl'
#     CSV_FILE_SC = f'./save/LJX_Convexplainer_enfr_20230922/cal_cross_D_i.csv'
