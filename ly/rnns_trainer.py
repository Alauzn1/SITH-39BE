...
def cli_main():
    ...
    parser.add_argument('--rnn_type', type=str, default='LSTM')  # RNN, LSTM, GRU
    # parser.add_argument('--attn_type', type=str, default='')  # dot_attn, tanh_attn
    # parser.add_argument('--attn_type', type=str, default='dot_attn')  # dot_attn, tanh_attn
    ...
    # parser.add_argument('--bi', action='store_true', default=True)  # 是否是双向的
    parser.add_argument('--dataset', type=str, default='imdb')  # sst/imdb/ag_news/yelp_polarity
    ...
    checkpoint_callback = ModelCheckpoint(monitor='valid_acc', mode='max', save_top_k=-1)
    # checkpoint_callback = ModelCheckpoint(save_top_k=-1)

    logger = TensorBoardLogger('logs/imdb-20', name='LSTM')
